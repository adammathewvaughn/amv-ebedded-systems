...
// const j = <FontAwesomeIcon icon={faRaspberryPi} /> <i className="fa-brands fa-raspberry-pi">{j}</i>
    ...
    <div className="container fluid">
      <div className="App col-md-6">
        ...
        <div className="content-left">
            <h1 className="slogan col-md-6">—— Automating a better tomorrow ——</h1>
            <p> &nbsp; &nbsp; Hi, my name is Adam M. Vaughn and I'm a Birmingham-area Embedded Systems engineer with an emphasis on incorporating Full-Stack Development
