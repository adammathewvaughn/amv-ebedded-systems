...
return (
    ...
    &nbsp;
    <a href="https://github.com/adammathewvaughn" target="_blank" rel="noopener noreferrer"> <i className="fas fa-github">{k}</i></a> | <a href="https://twitter.com/adammathewv" target="_blank" rel="noopener noreferrer"> <i className="fas fa-twittersquare"> {j}</i></a>| <a href="https://discord.gg/QDX6SpZe" target="_blank" rel="noopener noreferrer"> <i className="fas fa-discord"> {i}</i></a>
    </footer>
)
};
